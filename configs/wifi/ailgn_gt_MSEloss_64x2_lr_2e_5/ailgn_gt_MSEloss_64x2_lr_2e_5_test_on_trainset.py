_base_ = [
    '../../_base_/datasets/wifi_keypoint_test_on_trainset.py', '../../_base_/default_runtime.py'
]
model = dict(
    type='opera.PETR',
    backbone=dict(
...
work_dir = "/home/qianbo/wifipose/opera-main/result/ailgn_gt_MSEloss_64x2_lr_2e_5/ailgn_gt_MSEloss_64x2_lr_2e_5/"
