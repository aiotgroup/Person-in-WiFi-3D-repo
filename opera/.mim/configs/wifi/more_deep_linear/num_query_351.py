...
model = dict(
    ...
    test_cfg=dict(max_per_img=351))  # set 'max_per_img=20' for time counting
# optimizer
optimizer = dict(
    type='AdamW',
    lr=2e-5,
...
work_dir = "/home/qianbo/wifipose/opera-main/result/more_deep_linear/num_query_351"
